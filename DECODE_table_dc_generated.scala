...
class DECODE extends Module {
  ...
  val table = TruthTable(
    Map(
      BitPat("b?????????????????100?????0010011") -> BitPat("b 000 1 ? ? ? ??? ?? ?? ?? 101 01111 0 1 ?"), // XORI
      BitPat("b?????????????????000?????1100111") -> BitPat("b 000 1 1 ? ? 111 10 ?? ?? 101 10111 0 1 ?"), // JALR
      BitPat("b?????????????????100?????0000011") -> BitPat("b 000 1 ? ? 1 ??? ?? 00 ?? 001 00001 0 1 ?"), // LBU
      BitPat("b?????????????????010?????0000011") -> BitPat("b 000 1 ? ? 1 ??? ?? 01 ?? 100 00001 0 1 ?"), // LW
      BitPat("b?????????????????011?????0010011") -> BitPat("b 000 1 ? ? ? ??? ?? ?? ?? 101 10001 0 1 ?"), // SLTIU
      BitPat("b?????????????????000?????0000011") -> BitPat("b 000 1 ? ? 1 ??? ?? 00 ?? 000 00001 0 1 ?"), // LB
      BitPat("b?????????????????101?????0000011") -> BitPat("b 000 1 ? ? 1 ??? ?? 10 ?? 011 00001 0 1 ?"), // LHU
      BitPat("b?????????????????001?????0000011") -> BitPat("b 000 1 ? ? 1 ??? ?? 10 ?? 010 00001 0 1 ?"), // LH
      BitPat("b?????????????????000?????0010011") -> BitPat("b 000 1 ? ? ? ??? ?? ?? ?? 101 01100 0 1 ?"), // ADDI
      BitPat("b?????????????????111?????0010011") -> BitPat("b 000 1 ? ? ? ??? ?? ?? ?? 101 01101 0 1 ?"), // ANDI
      BitPat("b?????????????????110?????0010011") -> BitPat("b 000 1 ? ? ? ??? ?? ?? ?? 101 01110 0 1 ?"), // ORI
      BitPat("b?????????????????010?????0010011") -> BitPat("b 000 1 ? ? ? ??? ?? ?? ?? 101 10000 0 1 ?"), // SLTI
      BitPat("b?????????????????????????0010111") -> BitPat("b 001 1 ? ? ? ??? ?? ?? ?? 101 10010 0 ? ?"), // AUIPC
      BitPat("b?????????????????????????1101111") -> BitPat("b 010 1 1 ? ? 110 01 ?? ?? 101 10111 0 ? ?"), // JAL
      BitPat("b?????????????????001?????0100011") -> BitPat("b 011 ? ? 1 ? ??? ?? ?? 01 ??? 00000 0 1 1"), // SH
      BitPat("b?????????????????010?????0100011") -> BitPat("b 011 ? ? 1 ? ??? ?? ?? 10 ??? 00000 0 1 1"), // SW
      BitPat("b?????????????????000?????0100011") -> BitPat("b 011 ? ? 1 ? ??? ?? ?? 00 ??? 00000 0 1 1"), // SB
      BitPat("b?????????????????000?????1100011") -> BitPat("b 100 ? 1 ? ? 000 00 ?? ?? ??? ????? 0 1 1"), // BEQ
      BitPat("b?????????????????110?????1100011") -> BitPat("b 100 ? 1 ? ? 101 00 ?? ?? ??? ????? 0 1 1"), // BLTU
      BitPat("b?????????????????111?????1100011") -> BitPat("b 100 ? 1 ? ? 011 00 ?? ?? ??? ????? 0 1 1"), // BGEU
      BitPat("b?????????????????101?????1100011") -> BitPat("b 100 ? 1 ? ? 010 00 ?? ?? ??? ????? 0 1 1"), // BGE
      BitPat("b?????????????????100?????1100011") -> BitPat("b 100 ? 1 ? ? 100 00 ?? ?? ??? ????? 0 1 1"), // BLT
      BitPat("b?????????????????001?????1100011") -> BitPat("b 100 ? 1 ? ? 001 00 ?? ?? ??? ????? 0 1 1"), // BNE
      BitPat("b0000000??????????100?????0110011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 00110 0 1 1"), // XOR
      BitPat("b0100000??????????000?????0110011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 00011 0 1 1"), // SUB
      BitPat("b0000000??????????111?????0110011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 00100 0 1 1"), // AND
      BitPat("b0000000??????????011?????0110011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 01000 0 1 1"), // SLTU
      BitPat("b0000000??????????101?????0110011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 01010 0 1 1"), // SRL
      BitPat("b?????????????????????????0110111") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 10011 0 ? ?"), // LUI
      BitPat("b0100000??????????101?????0010011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 10110 0 1 ?"), // SRAI
      BitPat("b0000000??????????101?????0010011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 10101 0 1 ?"), // SRLI
      BitPat("b0000000??????????001?????0110011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 01001 0 1 1"), // SLL
      BitPat("b0000000??????????110?????0110011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 00101 0 1 1"), // OR
      BitPat("b0000000??????????000?????0110011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 00010 0 1 1"), // ADD
      BitPat("b0000000??????????010?????0110011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 00111 0 1 1"), // SLT
      BitPat("b0100000??????????101?????0110011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 01011 0 1 1"), // SRA
      BitPat("b0000000??????????001?????0010011") -> BitPat("b ??? 1 ? ? ? ??? ?? ?? ?? 101 10100 0 1 ?"), // SLLI
      BitPat("b00000000000000000000000001110011") -> BitPat("b ??? ? ? ? ? ??? ?? ?? ?? ??? ????? 0 ? ?"), // ECALL
      BitPat("b00000000000100000000000001110011") -> BitPat("b ??? ? ? ? ? ??? ?? ?? ?? ??? ????? 0 ? ?"), // EBREAK
    ), BitPat("b ??? ? ? ? ? ??? ?? ?? ?? ??? ????? 1 ? ?") // Invalid
  )
