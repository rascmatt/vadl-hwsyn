...
class DECODE extends Module {
  ...
  class IO extends Bundle {
    ...
    val read_is_BEQBLTBNEJALRBGEUBLTUBGEJAL_out = new VADL.RegReadPort(Bits(1.W))
  ...
  val is_BEQBLTBNEJALRBGEUBLTUBGEJAL = RegInit(0.U.asTypeOf(Bits(1.W)))
  ...
  dec_is_not_ADDIANDIORIXORISLTISLTI := false.B

  when (io.read_readMEM1_result_in.data.asUInt === BitPat("b0110011")) {
    when (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000000??????????000????????????")) {
      // ADD
      ...
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0100000??????????000????????????")) {
      // SUB
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      ...
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000000??????????111????????????")) {
      // AND
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      ...
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000000??????????110????????????")) {
      // OR
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      ...
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000000??????????100????????????")) {
      // XOR
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      ...
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000000??????????010????????????")) {
      // SLT
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      ...
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000000??????????011????????????")) {
      // SLTU
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      ...
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000000??????????001????????????")) {
      // SLL
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      ...
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000000??????????101????????????")) {
      // SRL
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      ...
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0100000??????????101????????????")) {
      // SRA
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      ...
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000001??????????000????????????")) {
      // MUL
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      ...
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000001??????????001????????????")) {
      // MULH
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      dec_bin_readMEM0_addr := 24.U
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000001??????????010????????????")) {
      // MULHSU
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      dec_bin_readMEM0_addr := 25.U
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000001??????????011????????????")) {
      // MULHU
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      dec_bin_readMEM0_addr := 26.U
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000001??????????100????????????")) {
      // DIV
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      dec_bin_readMEM0_addr := 27.U
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000001??????????101????????????")) {
      // DIVU
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      dec_bin_readMEM0_addr := 28.U
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000001??????????110????????????")) {
      // REM
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      dec_bin_readMEM0_addr := 29.U
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000001??????????111????????????")) {
      // REMU
      dec_is_not_SBSHSWBEQBNEBGEBGEUBLTB := true.B
      dec_sel_writeX0_value := 5.U
      dec_bin_readMEM0_addr := 30.U
      dec_is_not_AUIPCLUIJALECALLEBREAK := true.B
      dec_is_not_ADDIANDIORIXORISLTISLTI := true.B
    }.otherwise {
      // Invalid
  ...
  }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0010011")) {
  ...
  }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b1110011")) {
    when (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000000000000000000000000???????")) {
      // ECALL
    }.elsewhen (io.read_readMEM1_result_in.data.asUInt === BitPat("b0000000000010000000000000???????")) {
      // EBREAK
    }.otherwise {
      // Invalid
      dec_n_297 := true.B
  ...
  when ((io.DECODE_en_in).asBool) {
    is_BEQBLTBNEJALRBGEUBLTUBGEJAL := dec_n_280
  }
  when ((io.DECODE_en_in).asBool) {
  ...
  io.read_is_BEQBLTBNEJALRBGEUBLTUBGEJAL_out := is_BEQBLTBNEJALRBGEUBLTUBGEJAL
